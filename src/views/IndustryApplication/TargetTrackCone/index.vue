<template>
  <div class="app-wrapp">
    ...
    <div class="panel">
      <div class="panel-header">雷达追踪圆锥体</div>
      <div class="panel-body">
        <div class="tip-item">给定雷达点与目标点位置，自动计算目标点方向，生成追踪圆锥体</div>
...
import CesiumInit from "@/js/SampleItems/IndustryApplication/TargetTrackCone";
export default {
  name: "CesiumTargetTrackCone", 
  mounted() {
