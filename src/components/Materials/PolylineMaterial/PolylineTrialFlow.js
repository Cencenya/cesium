//尾迹线 流动
class PolylineTrialFlowMaterialProperty {
    constructor(options) {
...
Cesium.PolylineTrialFlowMaterialProperty = PolylineTrialFlowMaterialProperty;
...
export default PolylineTrialFlowMaterialProperty;