...
function PolylineLinkPulseMaterialProperty(color, duration) {
...
PolylineLinkPulseMaterialProperty.prototype.getValue = function(time, result) {
    ...
    result.image = Cesium.Material.PolylineLinkPulseImage;
...
Cesium.PolylineLinkPulseMaterialProperty = PolylineLinkPulseMaterialProperty;
Cesium.Material.PolylineLinkPulseType = 'PolylineLinkPulse';
Cesium.Material.PolylineLinkPulseImage = "../../static/images/effects/LinkPulse.png";
...
Cesium.Material._materialCache.addMaterial(Cesium.Material.PolylineLinkPulseType, {
    fabric: {
        ...
        uniforms: {
            ...
            image: Cesium.Material.PolylineLinkPulseImage,
            time: 20
        },
