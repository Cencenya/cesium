 //迁徙线
 class PolylineMigrateMaterialProperty {
     constructor(options) {
 ...
 PolylineMigrateMaterialProperty.prototype.getValue = function(time, result) {
     ...
     result.image = Cesium.Material.PolylineMigrateImage;
 ...
 Cesium.Material.PolylineMigrateImage = "../../static/images/effects/polylinemigrate.png";
 ...
 Cesium.PolylineMigrateMaterialProperty = PolylineMigrateMaterialProperty;
 Cesium.Material._materialCache.addMaterial(Cesium.Material.PolylineMigrateType, {
     ...
     fabric: {
         ...
         uniforms: {
             ...
             image: Cesium.Material.PolylineMigrateImage,
             transparent: true,
             time: 20
         },
 ...
 export default PolylineMigrateMaterialProperty;