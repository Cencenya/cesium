...
let cesiumInit = {
            ...
            for (let k = 0; k < itemArr.length; k++) {
                if (!!itemArr[k]) {
                    ...
                    if (item[0] !== '起点城市' || item[0] !== '迁出城市' && item.length > 1) {
                        ...
                        if (cityCenter1) {
                            if (Math.random() > 0.7) {
                                this.curive(cityCenter2, cityCenter1, 50);
                            }
                            data.push({
                                geometry: {
                                    type: 'LineString',
    ...
    initLayer(data) {
        ...
        let layer1 = new MapVLayer(this.viewer, dataSet, options);

        dataSet = new mapv.DataSet(this.timeData);
        options = {
        ...
        let layer2 = new MapVLayer(this.viewer, dataSet, options);
        return [layer1, layer2];
    },

    curive: function(fromPoint, endPoint, n) {
