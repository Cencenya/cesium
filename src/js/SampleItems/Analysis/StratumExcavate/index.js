...
import StratumExcavate from "@/components/Analysis/Excavate/StratumExcavate"
...
let cesiumInit = {
    ...
    //初始化开挖
    initExcavate() {
        this.stratumExcavate = new StratumExcavate(this.viewer);
        ...
        this.stratumExcavate.add(positions, {
            excavateDepth: 100
        });
    },
