...
import RegularSpreadWall from "@/components/SpecialEffects/Wall/RegularSpreadAnimate"
...
let cesiumInit = {
    ...
    addWalls() {
        ...
        let c1 = new CircleSpreadWall(this.viewer, p1, 500, 300, Cesium.Color.RED);
        let c2 = new RegularSpreadWall(this.viewer, 8, p2, 500, 300, Cesium.Color.AQUA);
        let c3 = new RegularSpreadWall(this.viewer, 5, p3, 500, 300, Cesium.Color.YELLOW);
    },
