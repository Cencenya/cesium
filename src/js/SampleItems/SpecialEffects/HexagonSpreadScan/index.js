// 六边形扩散扫描实例
import HexagonSpreadScan from "@/components/SpecialEffects/HexagonSpreadScan"
...
let cesiumInit = {
    ...
    addHexagons() {
        ...
        let h1 = new HexagonSpreadScan(this.viewer, p1, 500, Cesium.Color.RED);
        let h2 = new HexagonSpreadScan(this.viewer, p2, 500, Cesium.Color.AQUA);
        let h3 = new HexagonSpreadScan(this.viewer, p3, 500, Cesium.Color.YELLOW);
    },
