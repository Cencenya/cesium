...
import PlotDraw from "@/components/Plot/TextMapPlot/PlotDraw";
import PlotEdit from "@/components/Plot/TextMapPlot/PlotEdit";
import PlotLayer from "@/components/Plot/PlotLayer/TextMapPlot"
...
let cesiumInit = {
    ...
    //初始化数据
    initDatas() {
        fetch("../../static/data/1605104393540.json").then(res => {
            return res.json();
        }).then(res => {
