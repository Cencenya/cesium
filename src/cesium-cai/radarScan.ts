...
export const radarScan = (lon: number, lat: number, radius: number) => {


  // var lon = 119.91239801461403;//128.055;
  // var lat = 28.46349599393208;// 42.006;

  function AddRadarScanPostStage(viewer: any, cartographicCenter: any, radius: number, scanColor: any, duration: number) {
  ...
  var scanColor = Cesium.Color.CYAN;
  AddRadarScanPostStage(viewer, CartographicCenter, radius, scanColor, 4000);
}